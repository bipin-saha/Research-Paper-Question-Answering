...
st.set_page_config(page_title="Gemini ChatPDF Application", page_icon=":clipboard:", layout="wide")

image_path = "resources\chat_2.png"
...
st.markdown("<h1 style='text-align: center; color: black;'>ChatPDF</h1>", unsafe_allow_html=True)
